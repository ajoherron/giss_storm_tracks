...
#                   10 : "Troubled center"}
    ...
    # Edited on 01.31.2024 by Max Elling. In the original if you have "tracks" anywhere in your path it replaced it with dumped_centers and breaks.
    # The new code only makes the string replacement in the file
    tracks_file_fonly = tracks_file.split("/")[-1]
    tracks_file_edited = tracks_file_fonly.replace("tracks","dumped_centers")
    dumped_file = tracks_file.split(tracks_file_fonly)[0]  + tracks_file_edited
